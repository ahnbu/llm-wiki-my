...
> **BACKLOG — 후보와 하는 일.** 확정된 일과 아직 확정되지 않은 후보를 표 둘로 나눠 담는다.
> 근거·회고는 여기 두지 않는다 → _docs/. 운영 규칙 정본은 [문서_작성기준](file:///C:/Users/ahnbu/cowork/05_AI/global-rule-improve/문서_작성기준.md) §4·§5.
